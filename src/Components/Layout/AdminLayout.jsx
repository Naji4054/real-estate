        ...
        <List>
          {adminNavigation.map((navItem, index) => {
             if (!(navItem.children)) {
                ...
                return (
                    <>
                     <ListItemButton onClick={()=>handleMenuToggle(navItem.name)} >
                        <ListItemIcon>
                            {icons[navItem.icon]}
                        </ListItemIcon>
                        <ListItemText primary={navItem.name}/>
                        {openSubMenu[navItem.name]? <ExpandLess /> : <ExpandMore />}
                        </ListItemButton>

                        <Collapse in={openSubMenu[navItem.name]} timeout="auto" unmountOnExit>
